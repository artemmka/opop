  ...
  var Mode: integer; Ok: boolean;
    begin
      ...
      while Ok do
        begin
          ClrScr;
          GoToXY(0, 1);writeln('Выберетие пункт');
          GoToXY(0, 3);writeln('1:  Создать файл');
          GoToXY(0, 5);writeln('2:  Просмотр файла');
          GoToXY(0, 7);writeln('3:  Двоечнкики по матану');
          GoToXY(0, 9);writeln('4:  Двоечнкики по АиГ');
          GoToXY(0, 11);writeln('5:  Двоечнкики по ОП');
          GoToXY(0, 13);writeln('6:  Герои');
          GoToXY(0, 15);writeln('7:  Ветераны');
          GoToXY(0, 18);writeln('0:  Выход');
          GoToXY(0, 25);readln(Mode);
          ClrScr;
          case Mode of
            1: begin
                ClrScr;
